...
import MicroProfile from '../components/cityMiniCard';
							...
							<RB.Container>
								<div className="pt-3">
									...
									<div className="d-flex justify-content-between">
										<p className="text-muted display-6 fs-4"> 104 Courses </p>
										<p className="text-secondary display-6 fs-4">
											{' '}
											<RB.Image
												src={Img2}
												className="starmain"
									...
									<p className="text-muted display-6 fs-4"> 1425 Students Connected with us </p>
