...
import Img1 from "../../assets/images/icons/Image -57.png"
import { Link } from 'react-router-dom';

function NavbarCourseCard() {
		...
		<div className="d-flex justify-content-center pt-5">
			<RB.Card className=" hover">
				<div className="mainImgContainer p-3 ">
                    ...
                    <div className='NavCardImg d-flex justify-content-center align-items-center'> <RB.Image src={Img1} width="50px" />  </div>
                     </div>
				</div>
				
				<RB.Card.Body className="text-center">
					<RB.Card.Title className="fw-bold textColor">  Course Name </RB.Card.Title>
				 ...
				 <Link to="/Company-Profile">	<button className="button pe-4 ps-4 ms-3 me-3"> View Details</button> </Link>
...
export default NavbarCourseCard;
